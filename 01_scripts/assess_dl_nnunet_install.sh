...
conda create -n "$CONDA_ENV" -y python=3.10.9 anaconda

#Install Pytorch with conda https://pytorch.org/get-started/locally/
conda run -n "$CONDA_ENV" conda install -y pytorch torchvision torchaudio pytorch-cuda=11.7 -c pytorch -c nvidia
